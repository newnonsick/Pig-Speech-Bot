    ...
    async def callback(self, interaction: discord.Interaction):
        if self.values[0] == "Main Page":
            embedVar = (
                ...
                .set_author(
                    name="Pig Speech",
                    icon_url="https://cdn.discordapp.com/attachments/1041014713816977471/1216018350908379216/pig_logo_2.jpg?ex=65fedc57&is=65ec6757&hm=6e1d7e6c1f1c6a86e26a1072d7beef83a69ee33074b0925486745744c9e1612e&",
                )
                .set_image(url=self.buttomImage)
            )
            embedVar.add_field(
                name="🖥 INVITE BOT",
                value="┊[CLICK HERE](https://discord.com/oauth2/authorize?client_id=1196197441381339298)",
                inline=False,
            )
            embedVar.add_field(
                name="📖 Privacy Policy",
            ...
            embedVar = discord.Embed(
                title="📄 How to make a bot speak", description=""
            ).set_image(url=self.buttomImage)
            embedVar.add_field(
                name="",
                value="""             
...
- **`/xsaidname [on/off]`**: Toggle the feature that lets the bot read messages without announcing the user's name.
  ...
  - With `xsaidname on`: Typing "Hello" will make the bot say, "Hello"                                           
            ...
            embedVar = discord.Embed(
                title="📏 Slash Commands", description=""
            ).set_image(url=self.buttomImage)
            embedVar.add_field(
                name="Commands",
                value="""             
...
- **`/setlanguage [language_code]`**: Change the language the bot uses to speak, perfect for multilingual communities.
            ...
            embedVar = discord.Embed(
                title="🌐 Support Languages", description=""
            ).set_image(url=self.buttomImage)
            embedVar.add_field(
                name="Languages",
                value="""         
...
- **/setlanguage auto** > `Let the bot choose the language by itself`
            ...
            embedVar = discord.Embed(
                title="✈️ Support Languages 2", description=""
            ).set_image(url=self.buttomImage)
            embedVar.add_field(
                name="Languages",
                value="""
...
class Help(commands.Cog):
    ...
    async def help_command(self, interaction: discord.Interaction):
        ...
        embedVar = (
            ...
            .set_image(
                url="https://cdn.discordapp.com/attachments/1041014713816977471/1264297698190688316/PigSpeech.png?ex=669d5c7c&is=669c0afc&hm=8937ed0e690cf64479944749c2417e87c41cc4d1b18a9ddd826b01f8950da6df&"
            )
        )
        embedVar.add_field(
            name="🖥 INVITE BOT",
        ...
        await interaction.edit_original_response(
            embed=embedVar, view=Select_Help_View()
        )
